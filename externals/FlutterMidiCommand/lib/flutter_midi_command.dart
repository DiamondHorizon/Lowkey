...
final EventChannel _bleScanEventChannel = EventChannel('flutter_midi_command/ble_scan');
...
class MidiCommand {
  ...
  // void _listenToBleScanEvents() {
  //   _platform.onBleDeviceDiscovered?.listen((event) {
  //     if (event is Map<String, dynamic>) {
  //       _bleScanStreamController.add(event);
  //     }
  //   });
  // }
  ...
  Stream<Map<String, dynamic>> get onBleDeviceDiscovered {
    return _bleScanStreamController.stream;
  }
  final _bleScanStreamController = StreamController<Map<String, dynamic>>.broadcast();
  ...
  Future<void> startBluetoothCentral() async {
    ...
    _bleScanEventChannel.receiveBroadcastStream().listen((event) {
      if (event is Map) {
        _bleScanStreamController.add(Map<String, dynamic>.from(event));
      }
    });
  }
